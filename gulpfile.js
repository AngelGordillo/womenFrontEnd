...
var EE_ADDONS = require('ee-design-system/gulp-addons');
...
gulp.task('serve', ['vendorScripts', 'javascript', 'styles', 'fonts'], function () {
  browserSync({
    ...
    server: {
      ...
      middleware: EE_ADDONS.graphicsMiddleware(fs)
    }
  });
...
gulp.task('styles', function () {
  return gulp.src('app/assets/styles/main.scss')
    ...
    .pipe($.sass({
      ...
      includePaths: require('node-bourbon').with('node_modules/jeet/scss', EE_ADDONS.scssPath)
    }))
    .pipe($.sourcemaps.write())
...
gulp.task('images', function () {
  return gulp.src(['app/assets/graphics/**/*', EE_ADDONS.graphicsPath + '/**/*'])
    .pipe($.cache($.imagemin([
